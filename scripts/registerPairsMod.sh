...
GENERATED=$workDir/${mov_id}_To_${ref_id}
if [ ! -d $GENERATED ]; then
    mkdir $GENERATED
fi
...
BRAINIMAGE_MOV=/home/hwang3/SATA2013/MICCAI-2013-SATA-Challenge-Registration/canine-legs/Normalized/${mov_id}.nii.gz
BRAINIMAGE_MOV2=/home/hwang3/SATA2013/MICCAI-2013-SATA-Challenge-Registration/canine-legs/Normalized/${mov_id}_T2FS.nii.gz
...
BRAINIMAGE_FIX2=/home/hwang3/SATA2013/MICCAI-2013-SATA-Challenge-Registration/canine-legs/Normalized/${ref_id}_T2FS.nii.gz


OUTPUT=${GENERATED}/registeredFrom${mov_id}_To${ref_id}
OUTPUT_FILE=${GENERATED}/registeredFrom${mov_id}_To${ref_id}
REGISTERED_FINE_BRAIN=${OUTPUT}_image.nii.gz
REGISTERED_FINE_BRAIN2=${OUTPUT}_T2FS.nii.gz

imgs=" $BRAINIMAGE_FIX,$BRAINIMAGE_MOV "
imgs2=" $BRAINIMAGE_FIX2,$BRAINIMAGE_MOV2 "
...
regparams1="  -m Mattes[ $imgs ,1,32,Regular,0.05 ] -m Mattes[ $imgs2 ,1,32,Regular,0.05 ] -f 4x2x1 -s 2x1x0 -c [ 1000x1000x40,1e-08,10 ] "

regparams2="  -m Mattes[ $imgs2 ,1,32,Regular,0.05 ] -f 4x2x1 -s 2x1x0 -c [ 1000x1000x40,1e-08,10 ] "
...
$reg -d 3 -r [ $imgs, 1 ]  -o [$OUTPUT_FILE,$REGISTERED_FINE_BRAIN] \
    -t Rigid[0.1] $regparams \
    -t Similarity[0.1] $regparams1 \
    -t SyN[0.25,3,0] $regparams1 \
...
$BIN_ANTS/antsApplyTransforms -d 3 -r $BRAINIMAGE_FIX2 -i $BRAINIMAGE_MOV2 -o $REGISTERED_FINE_BRAIN2 -t ${OUTPUT_FILE}1Warp.nii.gz ${OUTPUT_FILE}0GenericAffine.mat -n BSpline

##rm ${OUTPUT_FILE}*Warp.nii.gz
